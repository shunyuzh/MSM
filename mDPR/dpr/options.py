...
def add_encoder_params(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--model_file", default=None, type=str,
                        help="Saved bi-encoder checkpoint file to initialize the model")  #  load checkpoint when continue train
    ...
    parser.add_argument("--normalization", action='store_true', help="whether to normalize the pooler output")
    
    parser.add_argument("--similarity", default="dot_product_scores", 
                        choices=["dot_product_scores", "cosine_scores", "additive_margin"], 
                        help="which similarity fuction to use")

    parser.add_argument("--pooling", default="cls", 
                        choices=["cls_pooler", "cls", "avg"], 
                        help="which pooling function to use")
