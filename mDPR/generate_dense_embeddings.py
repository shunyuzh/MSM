...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', type=int, default=2048, help="Batch size for the passage encoder forward pass")
    parser.add_argument('--log_file', type=str, default=None, help="log output")
    args = parser.parse_args()

    if args.log_file is None:
        args.log_file = os.path.join(os.path.dirname(args.out_file), 'logger_{}.log'.format(args.shard_id))
