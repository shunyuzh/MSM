...
#    os.environ["CUDA_VISIBLE_DEVICES"] = "0"
    ...
    print("debug getattr args data", getattr(args, 'data', ''))
    print("debug getattr args disable_reload_dataset", getattr(args, 'disable_reload_dataset', 'none'))
    ...
    while (
        ...
        # for roberta, no need to reload_dataset
        reload_dataset = not args.disable_reload_dataset
