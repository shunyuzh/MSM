...
def add_dataset_args(parser, train=False, gen=False):
    ...
    if train:
        ...
        group.add_argument('--disable-reload-dataset', default=False, action='store_true',
                           help='disable reload dataset, for roberta or bert')
        group.add_argument('--gather-log-dir', default=None, type=str,
                           help='gather_log_dir')
        group.add_argument('--enable-cross-gpu', default=False, action='store_true',
                           help='enable_cross_gpu')
        group.add_argument('--nega-gpu', default=1, type=int, metavar='N',
                           help='nega_gpu: how many gpus negatives are collected')
        group.add_argument('--enable-lgmask', default=False, action='store_true',
                           help='enable_lgmask')
        group.add_argument('--enable-cross-gpu-data', default=False, action='store_true',
                           help='enable_cross_gpu_data')
    if gen:
